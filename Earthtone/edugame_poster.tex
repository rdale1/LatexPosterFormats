...
%\setbeamercolor{block title}{fg=white, bg=MistyRose}
...
%\includepdf[pages={1}]{cellcycleposter.pdf}
...
\begin{enumerate}
	\itemsep0em 
	%	\item give players exposure to math, which can decrease math-phobia 
	%\item gain math confidence
	%\item gain an appreciation for plant traits and adaptations, which increases plant interest 
	%\item gain exposure to mathematical modeling
	%\item and develop testable hypotheses in an inquiry-based electronic lab setting. 
	\item Gain increased \textbf{confidence in their math skills}%become more familiar with mathematical modeling
	\item Gain \textbf{appreciation and interest }in plant biology \cite{plantinterest1}%appreciate and visualize the invisible behaviors of plants
	\item Gain\textbf{ exposure to mathematical modeling} as a scientific tool 
	%	\item improve their ability to reason in terms of systems %learn to think in terms of systems
	\item Improve their \textbf{engagement }via inquiry-based learning \cite{math2}%conduct virtual experiments and test their hypotheses
\end{enumerate}
}
...
%\end{minipage}%
%\begin{minipage}{.5\textwidth}
			%	\includegraphics[width=.8\linewidth]{LSU_Purple_RGB.png} %& \hfill & 
%\end{minipage}
...
%\begin{figure}%%
%	\centering
%	\animategraphics[width=.8\linewidth,loop,autoplay]{10}{./gifs/img00}{01}{54}
%\end{figure}
